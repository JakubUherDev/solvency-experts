    ...
    <footer>
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12 border-t border-gray-200">
          ...
          <div className="sm:col-span-12 lg:col-span-3">
            ...
            <div className="text-sm text-white">
              <Link to="#" className="text-white hover:text-gray-900 hover:underline transition duration-150 ease-in-out">Terms</Link> · <Link to="#" className="text-white hover:text-gray-900 hover:underline transition duration-150 ease-in-out">Privacy Policy</Link>
            </div>

          </div>

          {/* 2nd block */}
          <div className="sm:col-span-6 md:col-span-4 lg:col-span-3 text-white">
            <h6 className="text-white font-medium mb-2">Address</h6>
            <ul className="text-sm">
              <li className="mb-2 flex space-x-2 ">
                <span className={'p-1'}>
                  <FaMapMarkerAlt />
                </span>
                <p className="text-white hover:text-gray-100 transition duration-150 ease-in-out"> 8 Royal Parade<br/>London<br/>W5 1ET</p>
              </li>
              <li className="mb-2 flex space-x-2 ">
                <span className={'p-1'}>
                  <BsFillTelephoneFill />
                </span>
                <p className="text-white hover:text-gray-100 transition duration-150 ease-in-out">0208 354 2495</p>
              </li>
            </ul>
          </div>
          ...
          <div className="sm:col-span-6 md:col-span-3 lg:col-span-3">
            ...
            <ul className="text-sm">
              <li className="mb-2">
                <Link to="#" className="text-white hover:text-gray-900 transition duration-150 ease-in-out">Voluntary Liquidation</Link>
              </li>
              <li className="mb-2">
                <Link to="#" className="text-white hover:text-gray-900 transition duration-150 ease-in-out">Compulsory Liquidation</Link>
              </li>
              <li className="mb-2">
                <Link to="#" className="text-white hover:text-gray-900 transition duration-150 ease-in-out">Bounce Back Loan</Link>
              </li>
              {/*<li className="mb-2">*/}
          ...
          {/*          <input id="newsletter" type="email" className="form-input w-full text-white px-3 py-2 pr-12 text-sm" placeholder="Your email" required />*/}
        ...
        <div className="md:flex md:items-center md:justify-between py-4 md:py-8 border-t border-gray-200">
          ...
          {/* Copyrights note */}
          <div className="text-sm text-white mr-4">Made by <a className="text-blue-200 hover:underline" href="https://kdev-solutions.co.uk/">KDev Solutions</a>. All rights reserved.</div>
